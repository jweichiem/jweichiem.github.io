const en = {
	...
	sections: [
		...
		},
		{
			...
			cards: [
				{
					title: 'Checks currently in place',
					description:
					...
					items: [
						...
						'Automated accessibility checks with Vitest and axe-core.',
					],
				},
				{
					title: 'Automated accessibility test summary',
					description:
						'The current automated audit runs against the prerendered pages generated by the site.',
					items: [
						'Command: npm run test:a11y.',
						'Runtime: Vitest with jsdom plus axe-core.',
						'Coverage: all 10 current SSG routes in English and Swedish.',
						'Routes covered: /, /sv, /engineering, /sv/engineering, /accessibility, /sv/accessibility, /cv, /sv/cv, /about, /sv/about.',
						'Current result: 10 of 10 route checks passed with no axe violations.',
						'Note: color contrast is still reviewed separately because jsdom does not compute rendered colors reliably.',
					],
				},
			],
		},
